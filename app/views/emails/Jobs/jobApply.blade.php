                            ...
                            <td width="100%" align="left" style="padding: 20px 10px;">
                                ...
                                <span style="color:#666666; font-size: 14px; line-height: 24px; ">
                                   ...
                                   <span style=" font-weight: bold;"> {{$fromName}} </span> recently applied for job you posted: <br /><br />
                                    ...
                                    <span style="color: #777;">PS: For more information, please login to  <span style=" font-weight: bold;">Jagirr</span>.</span>

                                </span>
                            </td>
                        <tr>
                            <td width="100%" align="left" style="padding: 0 10px; color:#666666; font-size: 14px; line-height: 24px; ">
                                {{$signature}} <br /><br />
                            </td>
                        </tr>
